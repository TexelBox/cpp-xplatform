...
- **TODO: USE 'project-name' AND 'project_name' AS IDENTIFIERS**
- **TODO: MIGRATE TO CMAKE 3.16 AND REMOVE COTIRE / REPLACE PARTS OF SCRIPTS WITH MORE MODERN METHODS**
- **TODO: MAKE SURE EXTERNAL-TESTS TARGET PROPERTIES ARE CONSISTENT WITH MAIN TARGET**
- **TODO: ADD SEMANTIC VERSIONING SUPPORT / "--version"**
- **TODO: CHANGE PROJECT STRUCTURE TO BE MORE INTUITIVE TO ADD NEW SCRIPTS THAT DO NOT CONFLICT IN BUILD OUTPUT**
- **TODO: ADD USER BUILD SCRIPTS**
- **TODO: ADD SCRIPTS FOR VS2019**
- **TODO: ADD SCRIPTS FOR GCC/CLANG FORCING**
- **TODO: ADD MORE COMPILER VERSIONS TO TRAVIS CONFIG**
- **TODO: CLEANUP/SIMPLIFY ALL FILES (ESPECIALLY THE CI SCRIPTS)**
- **TODO: ADD PROJECT RENAME SCRIPT(S)**
- **TODO: ADD THE ISSUE/PR/etc. TEMPLATES**
- **TODO: FIX ALL COMPILER WARNINGS IN THE SAMPLE CODE**
- **TODO: ADD PROJECT SETUP PROCESS**
- **TODO: ADD MORE DOCUMENTATION**
- **TODO: ADD OPTION FOR SETTING MSVC SUBSYSTEM TO WINDOWS TO HIDE CONSOLE FOR GUI APPS**
- **TODO: ADD DLL COPYING / SHARED LIBRARY SUPPORT**
- **TODO: ADD CCACHE SUPPORT**
- **TODO: ADD BETTER SUPPORT FOR BUILDING LIBRARY TARGETS**
