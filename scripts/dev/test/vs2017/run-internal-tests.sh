...
./build/vs2017/x86/Debug/project-name.exe --dt-exit=true --dt-no-run=false

echo "RUNNING MINSIZEREL INTERNAL TESTS..."
./build/vs2017/x86/MinSizeRel/project-name.exe --dt-exit=true --dt-no-run=false

echo "RUNNING RELEASE INTERNAL TESTS..."
./build/vs2017/x86/Release/project-name.exe --dt-exit=true --dt-no-run=false

echo "RUNNING RELWITHDEBINFO INTERNAL TESTS..."
./build/vs2017/x86/RelWithDebInfo/project-name.exe --dt-exit=true --dt-no-run=false
# END of running for x86

# RUN x64...
echo "RUNNING x64 INTERNAL TESTS..."
echo "RUNNING DEBUG INTERNAL TESTS..."
./build/vs2017/x64/Debug/project-name.exe --dt-exit=true --dt-no-run=false

echo "RUNNING MINSIZEREL INTERNAL TESTS..."
./build/vs2017/x64/MinSizeRel/project-name.exe --dt-exit=true --dt-no-run=false

echo "RUNNING RELEASE INTERNAL TESTS..."
./build/vs2017/x64/Release/project-name.exe --dt-exit=true --dt-no-run=false

echo "RUNNING RELWITHDEBINFO INTERNAL TESTS..."
./build/vs2017/x64/RelWithDebInfo/project-name.exe --dt-exit=true --dt-no-run=false
